...
namespace Common_Control
{
        ...
        public:
                ...
                void Tracking_Path_stanley(const Path_Type &path_vector, double kp , double speed, bool is_robot1);
                void Tracking_Path_pure_pursuit(const Path_Type &path_vector, double ld, double speed, bool is_robot1);
